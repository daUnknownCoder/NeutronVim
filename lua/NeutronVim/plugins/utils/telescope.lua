return {
  {
    ...
    keys = {
      ...
      { "fb", "<cmd>Telescope buffers<CR>", desc = "Find Buffers [Telescope]" },
      { "fo", "<cmd>Telescope colorscheme<CR>", desc = "Choose Colorschemes [Telescope]" },
    ...
    dependencies = {
      ...
      { 
        ...
        -- build = vim.fn.executable("make") == 1 and "make" or "cmake -S. -Bbuild -DCMAKE_BUILD_TYPE=Release && cmake --build build --config Release",
      },
    },
    config = function()
