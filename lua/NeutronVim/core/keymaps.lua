...
-- windows
map("n", "<leader>sd", "<C-W><C-W>", { desc = "Next Part of window" })
map("n", "<leader>sq", "<C-W>c", { desc = "Delete window", remap = true })
map("n", "<leader>sh", "<C-W>s", { desc = "Split window below", remap = true })
map("n", "<leader>sv", "<C-W>v", { desc = "Split window right", remap = true })
map("n", "<leader>se", "<C-W>=", { desc = "Make splits of equal size", remap = true })
map("n", "<leader>sx", "<cmd>close<cr>", { desc = "Close window", remap = true })
